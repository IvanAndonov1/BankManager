		...
		<div className="min-h-screen flex bg-white">
			...
			<div className="flex-1 p-8 ml-12 flex flex-col gap-12">
				...
				<div className="grid grid-cols-2 gap-2">
					<MoneyTransferCard
						transfer="Between Your Cards"
						onClick={() => setIsModalOpen(true)}
					/>
					<MoneyTransferCard
						transfer="To Another Account"
						onClick={() => setIsAnotherAccountOpen(true)}
					/>
				</div>

				<Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
				<AnotherAccount
					isOpen={isAnotherAccountOpen}
					onClose={() => setIsAnotherAccountOpen(false)}
				/>
				...
				<div className="w-full flex flex-col gap-6">
					<div className="grid grid-cols-2 gap-2">
						...
						<input
							className="mt-4 w-96 p-3 text-gray-400 border border-gray-300 focus:outline-none focus:ring-1 focus:ring-[#351f78] rounded-3xl"
