  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      ></div>
       ...
       <h2 className="text-sm text-gray-500 mb-4 text-center">To Another Account</h2>
       ...
       <p className="text-normal font-light mb-4">First Surename Last</p>
       <p className="text-normal font-light mb-4">To</p>
       
         <input
            type="text"
            placeholder="Enter the IBAN of the recipient's account"
