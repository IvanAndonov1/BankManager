      ...
      <div className="relative w-full h-full bg-gradient-to-br from-[#6a1f78] via-[#444895] to-[#0b82be]">
        ...
        <Link
          ...
          className="cursor-pointer absolute top-8 right-6 z-30 px-7 pt-2 h-10 rounded-full text-white font-medium
            ...
            before:border-t before:border-white/40 overflow-hidden"
        >
          Sign in
        </Link>
        ...
        <div className="absolute -left-20 -top-24 w-64 h-64 rounded-full
                        bg-[radial-gradient(circle_at_30%_30%,#8a2c9a,#5b1d91_60%,#2b0b3f_100%)] opacity-90" />
        ...
        <div className="absolute right-[18%] top-[44%] w-8 h-8 rounded-full
                        bg-[radial-gradient(circle_at_30%_30%,#8a2c9a,#5b1d91_60%,#2b0b3f)]" />
        <div className="absolute -left-10 -top-20 w-64 h-64 rounded-full
						bg-[radial-gradient(ellipse_53.95%_53.96%_at_46.56%_46.16%,_#A5438B_0%,_#351F78_100%)]" />

        <img src={lines} alt="lines" className="absolute inset-0 w-2xl h-md object-cover opacity-50" />

      
        <section className="relative z-20 pl-16 pt-52 max-w-xl text-white">
          <h1
            className={`text-[44px] leading-tight font-semibold drop-shadow-[0_4px_20px_rgba(0,0,0,.25)]
          ...
          <p
            className={`mt-4 text-white/90 text-md leading-6 font-medium pr-4
        ...
        <div className="pointer-events-none absolute right-[20%] top-[20%] -rotate-[20deg] py-6">
          ...
          <div
            className={`absolute -rotate-[20deg] -translate-y-4 translate-x-24 w-[320px] h-52 
                        bg-gradient-to-br from-white/0 to-white/40 rounded-2xl border border-white/20 
          ...
          >
            ...
            <div className="absolute left-6 bottom-8 text-white/80">Petur Petrov</div>
          </div>

         
          <div
            className={`relative mt-48 w-[320px] h-52 rounded-2xl bg-white/10 backdrop-blur-xl 
                        border border-white/20 hover:bg-white/20
                        before:absolute before:inset-0 before:rounded-2xl 
                        before:bg-gradient-to-t before:from-white/20 before:to-transparent 
                        before:border-t before:border-white/40 overflow-hidden z-10
          ...
          >
            ...
            <div className="absolute left-6 bottom-8 text-white/80">Ivana Ivanova</div>
          </div>
        </div>
