		...
		<div className="min-h-screen flex bg-gray-100">
			...
			<div className="flex-1 p-6 space-y-6">
				...
				<div className="flex gap-6">
					<ProfileCard title={employee.fullName} subtitle={employee.username} footerActionLabel="Remove Account" employee={employee} />
					<div className="flex-1 min-w-0 bg-white rounded-2xl shadow-md overflow-hidden">
						...
						{tab === "profile" && <ProfileTab key={employee.username} employee={employee} />}
