	...
	return (
		<div className="p-10 flex flex-col items-center gap-10">
			<div className="flex items-center justify-center gap-16 mt-10">
				<button type="button" aria-label="decrease" onClick={() => setSalary((s) => Math.max(0, s - 50))} className="cursor-pointer w-12 h-12 rounded-full ring-2 ring-[#351F78] text-[#351F78] text-3xl flex items-center justify-center">−</button>
