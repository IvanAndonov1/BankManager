	...
	return (
		<div className="space-y-6">
			...
			<label className="block text-sm text-white/90">
				...
				<input type="password" value={values.password || ""} onChange={(e) => onChange?.({ password: e.target.value })} className="w-full bg-transparent border-b border-white/40 h-10 px-1 text-white outline-none" />
			</label>
			<label className="block text-sm text-white/90">
				<span className="block mb-2">Confirm Password</span>
				<input type="password" value={values.confirmPassword || ""} onChange={(e) => onChange?.({ confirmPassword: e.target.value })} className="w-full bg-transparent border-b border-white/40 h-10 px-1 text-white outline-none" />
			</label>
